            ...
            <!-- Add icons to the links using the .nav-icon class
                ...
                <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('dashboard/FirstYear')}}" class="nav-link ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('dashboard/SecondYear')}}" class="nav-link ">
                            <i class="far fa-circle nav-icon"></i>
                            <p>السنة الثانية</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{url('dashboard/ThirdYear')}}" class="nav-link ">
                            <i class="far fa-circle nav-icon"></i>
                            <p>السنة الثالثة</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{url('dashboard/FourthYear')}}" class="nav-link ">
                            <i class="far fa-circle nav-icon"></i>
                            <p>السنة الرابعة</p>
                            </a>
                        </li>
