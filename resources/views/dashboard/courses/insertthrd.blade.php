    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="mx-auto col-6 m-4">
                ...
                <form action="{{url('dashboard/courses/postcourse3')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            ...
                            <a href="{{url('dashboard/ThirdYear')}}" class="btn btn-secondary float-right">Show Courses</a>
                        </div>
